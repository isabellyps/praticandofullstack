...
namespace DevIO.Api.Controllers
{
    ...
    public class ProdutosController : MainController
    {
        ...
        {
            var imageDatagByteArray = Convert.FromBase64String(arquivo);
            ...
            System.IO.File.WriteAllBytes(filePath, imageDatagByteArray);
        ...
        private async Task<bool> UploadArquivoAlternativo(IFormFile arquivo, string imgPrefixo)
        {
            ...
            {
                NotificarErro("Forneça uma imagem para estre produto!");
                return false;
            }
